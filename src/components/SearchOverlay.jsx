...
const SearchOverlay = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-[#141414]/98 flex flex-col">
      {/* Search bar */}
      <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-5 lg:px-10 py-4 sm:py-5 border-b border-white/10">
        ...
        <input
          ...
          placeholder="Cari kenangan, orang, tempat..."
          className="flex-1 bg-transparent text-white text-base sm:text-lg lg:text-xl outline-none placeholder:text-gray-600"
        />
        <button
          onClick={onClose}
          className="text-gray-500 hover:text-white transition-colors p-1.5 sm:p-1 -mr-1"
        >
          <X size={22} />
        </button>
      </div>
      ...
      {/* Results */}
      <div className="flex-1 overflow-y-auto px-4 sm:px-5 lg:px-10 py-4 sm:py-6">
        {query.length < 2 && (
          <div className="text-center mt-16 sm:mt-24">
            <p className="text-gray-600 text-base sm:text-lg">Mulai ketik untuk mencari kenangan...</p>
